...
const WideScreen = ({ loading }: IProps) => {
  ...
  useEffect(() => {
    if (!loading) {
      ...
      gsap
        ...
        .to(
          heroDiv('#big-mnt-img'),
          { top: '25vh', duration: 1, ease: 'none' },
          '<'
        )
        .to(
          heroDiv('#mid-mnt-img'),
          { top: '40vh', duration: 1, ease: 'none' },
          '<'
        )
        .to(
          heroDiv('#uiux-dev-txt'),
          { top: '80vh', duration: 1, ease: 'none', translateY: '-=50%' },
          '<'
        )
        .to(
          heroDiv('#sm-mnt-back'),
          { top: '70vh', xPercent: 0, zoom: 1.1, duration: 1, ease: 'none' },
          '<'
        )
        .to(
          heroDiv('#climb-mnt'),
          { top: '80vh', left: '50%', duration: 1, ease: 'none' },
          '<'
        )
        .to(
          heroDiv('#sm-mnt-front'),
          { top: '80vh', xPercent: 0, duration: 1, ease: 'none' },
          '<'
        )
        .to(
          heroDiv('.cloud-left'),
        ...
        .to(
          ...
          { top: '90vh', duration: 1, ease: 'none', opacity: 0.3, x: -300 },
          '<'
        )
        .to(
          heroDiv('#cta-btn'),
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className='absolute w-3/4 xl:w-2/3 h-auto z-10' id='uiux-dev-txt'>
          <HeroSvg.UXDevWide />
        </div>
        ...
        <div
          className='absolute left-0 w-full h-auto opacity-90 z-40'
          id='sm-mnt-back'
        >
          <Image
            alt=""
        ...
        <div
          className='absolute transform -translate-x-1/2 w-1/4 z-40'
          id='climb-mnt'
        >
          <Image
            alt=""
        ...
        <div className='absolute right-0 z-50' id='cta-btn'>
          ...
          >
            <span className='block font-wask font-semibold text-left text-sm'>
              Read The
            </span>
            3-3-3 Principles
