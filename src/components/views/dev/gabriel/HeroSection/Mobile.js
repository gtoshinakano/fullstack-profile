...
const Mobile = ({ loading }) => {
  ...
  useEffect(() => {
    if (!loading) {
      ...
      gsap.set(heroDiv("#uiux-dev-txt"), { top: "50vh", left: "50%", translateX: "-50%", translateY: "-70%" });
      gsap.set(heroDiv("#sm-mnt-back"), { top: "64vh", xPercent: -10 });
      gsap.set(heroDiv("#climb-mnt"), { top: "95vh", left: "40%", scaleY: 0.2 });
      gsap.set(heroDiv("#sm-mnt-front"), { rotateY: 180, xPercent: -45, top: "78vh" });
      gsap.set(heroDiv(".cloud-left"), { rotateY: 180, top: "63vh", opacity: 0.5 });
      ...
      const tl = gsap.timeline({
        ...
        .to(heroRef.current, { backgroundPosition: "0 -110px", ease: "none", duration: 1 })
        .to(heroDiv("#big-mnt-img"), { top: "30vh", duration: 1, ease: "none" }, "<")
        .to(heroDiv("#mid-mnt-img"), { top: "45vh", duration: 1, ease: "none" }, "<")
        .to(heroDiv("#uiux-dev-txt"), { top: "50vh", duration: 1, ease: "none", translateY: "-30" }, "<")
        .to(heroDiv("#sm-mnt-back"), { top: "64vh", xPercent: 0, duration: 1, ease: "none" }, "<")
        .to(heroDiv("#climb-mnt"), { top: "66vh", left: "50%", scale: 1, duration: 1, ease: "none" }, "<")
        .to(heroDiv("#sm-mnt-front"), { top: "72vh", xPercent: -50, duration: 1, ease: "none" }, "<")
        .to(heroDiv(".cloud-left"), { duration: 1, ease: "none", opacity: 0.3, xPercent: -30 }, "<")
        .to(heroDiv(".cloud-right"), { top: "76vh", duration: 1, ease: "none", opacity: 0.1, xPercent: 30 }, "<")
        .to(heroDiv(".cloud-center"), { top: "82vh", duration: 1, ease: "none", opacity: 0.1, x: -50 }, "<")
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span className='block font-wask text-left tracking-widest leading-relaxed font-thin'>Read The</span>
            3-3-3 Principles
