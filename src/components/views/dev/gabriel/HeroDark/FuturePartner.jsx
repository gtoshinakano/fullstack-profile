  ...
  return (
    <>
      ...
      <div ref={containerRef} className="space-y-4 lg:space-y-6 text-lg lg:text-xl lg:max-w-3xl tracking-wider font-openSans">
        ...
        <h3 className='should-hide text-3xl font-semibold font-futura pt-5 text-center md:text-left'>If you need a <span className='text-primary'>UI/UX Designer</span></h3>
        ...
        <h3 className='should-hide text-3xl font-semibold font-futura pt-5 text-center md:text-left'>If you need a <span className='text-primary'>Frontend Developer</span></h3>
        ...
        <h3 className='should-hide text-3xl font-semibold font-futura pt-5 text-center md:text-left'>If you <span className='text-primary capitalize'>hire me</span></h3>
